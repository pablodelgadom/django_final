...
class Mensaje:
    idEmisor=models.ForeignKey(User, on_delete=models.CASCADE, max_length=11, null=False)
    idReceptor=models.ForeignKey(User, on_delete=models.CASCADE, max_length=11, null=False)
    fecha=models.DateField(verbose_name="Fecha", null=False)
